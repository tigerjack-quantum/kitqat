...
from kitqat.qroutines.hamming_weight_generate import benes_network
...
class BenesTestCase(CircuitTestCase):
    ...
    def setUpClass(cls):
        ...
        perm_logger = logging.getLogger("isdquantum.qroutins.hamming_weight_generate")
    ...
    def test_patterns(self, name, n, w, reverse):
        ...
        res = self.qpu.submit(
            self.circuit.to_circ().to_job(qubits=[q.index for q in selectors_q])
        )
