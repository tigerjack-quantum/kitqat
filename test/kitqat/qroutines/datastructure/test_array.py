...
from kitqat.qroutines.datastructure.array import contains
from kitqat.qroutines.qregs_mgmt.qregs_init import initialize_qureg_given_int
from kitqat.utils.bits.conversion import (get_int_from_bitarray,
...
if __name__ == '__main__':
    ...
    logging.getLogger("kitqat.qroutines.datastructure.arrays").setLevel(
        logging.DEBUG)
    logging.getLogger(
