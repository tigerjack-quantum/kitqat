...
from qatext.utils.bits.conversion import get_int_from_bitarray, get_int_from_bitstring, get_ints_from_bitarray
...
class TestArrays(CircuitTestHelpers):
    ...
    def test_element_in_array(self, element, array, expected):
        n = len(array)
...
if __name__ == '__main__':
    ...
    test.test_element_in_array(3, [1, 2, 3, 4], True)
    # 🔥 Runs the test
