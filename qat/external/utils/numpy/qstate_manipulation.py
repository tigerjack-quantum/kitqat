...
def get_transpose_from_matrix(gate_matrix: np.ndarray) -> np.ndarray:
    return gate_matrix.T


def get_conjugate_from_matrix(gate_matrix: np.ndarray) -> np.ndarray:
    return gate_matrix.conj()


def get_dagger_from_matrix(gate_matrix: np.ndarray) -> np.ndarray:
    return gate_matrix.T.conj()


def get_start_state(n_qubits: int) -> np.ndarray:
...
def get_state_as_tensor(state_vec: np.ndarray) -> np.ndarray:
...
def get_tensor_from_matrix(matrix: np.ndarray) -> np.ndarray:
